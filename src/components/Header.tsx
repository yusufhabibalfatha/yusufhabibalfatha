        ...
        <header className="min-h-screen p-6 hero bg-base-200">
            <div className="flex-col hero-content lg:flex-row-reverse lg:gap-24">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p>A Specialist in Website Development. <br></br>I assist with minor web development tasks, but my main priority is creating websites quickly and flawlessly.</p>
                    <p></p>
                    <a href="#overview" className="btn btn-primary w-max">Let's jump!</a>
                </div>
            </div>
        </header>
    );
